...
const createList = async (arg) => {
  ...
  return list.save()
    .then((result) => {
      console.log(`c createList SaveOne: ${JSON.stringify(result)}`);
      const newList = {
        id: result._id,
        title: result.title,
